...
<head>
    ...
    <title>Graphics & Design FAQs</title>
</head>
...
<div class="faq">
    ...
    <label for="faq-c">
        <p class="faq-heading">How much does it cost to hire a graphic designer</p>
        <div class="faq-arrow"></div>
        <p class="faq-text">
    ...
    <label for="faq-e">
        <p class="faq-heading">What’s the best way to hire a designer in less than 48 hours?</p>
        <div class="faq-arrow"></div>
        <p class="faq-text">
            ...
            you only have 48 hours to go before the deadline. If you find
            yourself in this position here are some tips and tricks to help you
            make the right choice: - Prepare a super clear creative brief
            (including ideas and examples); - Use Fiverr’s filters to refine your
            search by talent availability, deadline, price range, location or
            language; - Write to multiple sellers at the same time (use a clear
            subject line so they know you are serious); - When you’ve narrowed it
            down to one designer based on your brief, go through their previous
            projects and reviews carefully and make sure that you’ve chosen the
