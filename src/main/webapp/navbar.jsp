...
<body>
<div id="navbar">
    <img class="logo" src="assets/landing page imgs/workpulse.png" alt="logo">

    <input type="text" id="query" placeholder="What service are you looking for today">
    <svg
            id="search" width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
    ...
    <h4 style="color: #1e1692;">WorkPulse Business</h4>
    <h4>Explore</h4>
    <h4>English</h4>
    <h4>₹ INR</h4>
    <h4>Become a Seller</h4>
    <a href="./login.jsp"><h4 id="userid">Sign In</h4></a>
    <a href="./signup.jsp">
